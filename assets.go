...
func configsCsvExampleYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "configs/csv-example.yaml", size: 135, mode: os.FileMode(420), modTime: time.Unix(1441673139, 0)}
...
func configsDfYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "configs/df.yaml", size: 386, mode: os.FileMode(420), modTime: time.Unix(1441663244, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func configsTopYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "configs/top.yaml", size: 2242, mode: os.FileMode(420), modTime: time.Unix(1441662848, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
